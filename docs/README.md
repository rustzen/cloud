...
- untracked source candidates during this standardization pass:
  ...
  `src/lib/creem.ts`, `src/lib/creem.test.ts`
...
Rustzen Clear Pro checkout is modeled as a Creem annual subscription: USD
$10/year, product id `prod_4Wa3YyJe3bn8hNuotPlSYj`.
